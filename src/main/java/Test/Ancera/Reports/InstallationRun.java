...
public class InstallationRun {
	...
	public void NavigatePiperConfig() throws InterruptedException, IOException {
		...
		try{
			Test_Variables.test = Test_Variables.extent.createTest("AN-IR-01: Verify user can navigate to Piper Configuration Screen", "This test case will verify user can navigate to Piper Configuration Screen");
			...
			Test_Variables.test.addScreenCaptureFromPath(Helper.getScreenshot("Piper Configuration", Constants.InstallationRunReportPath));
	...
	public void Navigatesal() throws InterruptedException, IOException {
		...
		/*
			...
			Helper.driver.findElement(By.cssSelector("#sort-sampleId .form-control")).sendKeys("TestAutomation15733");
			Test_Elements.wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
			Thread.sleep(3000);						


		//	Helper.driver.findElement(By.cssSelector("list-title_cust-cb-lst-txt_TestAutomation15733")).click();
			Helper.driver.findElement(By.id("TestAutomation15733")).click();
			Test_Elements.wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
			Thread.sleep(1500);
		...
		for (InstallationRunModel objModel : Test_Variables.lstInstallationRunCreate) { 
			try{
				...
				for (ReportFilters objFilter : objModel.lstFilters) {
					...
					System.out.println("2. "+Test_Variables.lstOutcome.get(i));
					i++;
				}
	...
	public void installationRunConfig() throws InterruptedException, IOException {
