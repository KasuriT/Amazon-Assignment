				...
				if (objModel.runTemplateUpload) {
					if (Integer.parseInt(Helper.driver.findElement(By.id("results-found-count")).getText()) == 12) {
						...
						if (objModel.invalidSampleMatrix) {
							...
							for (int i=0; i<12; i++) {
								cell=worksheet.getRow(i+1).createCell(5); 
								cell.setCellValue(objModel.newSampleMatrix); 
								fsIP.close();
							}
...
*/
	...
	public void PAConfigurattion() throws InterruptedException, IOException {
	//	SoftAssert softAssert = new SoftAssert();
/*
		Helper.driver.get(Constants.url_SalmonellaLog);
		Test_Elements.wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
		...
		Thread.sleep(1000);
		Helper.driver.findElement(By.id("sampleId_search-input")).clear();
		Helper.driver.findElement(By.id("sampleId_search-input")).sendKeys("20210921-TestAut-PA-11121");
		Test_Elements.wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
		Thread.sleep(2000);		
		try {
			Helper.driver.findElement(By.cssSelector("#sampleId_cust-cb-lst-txt_20210921-TestAut-PA-11121 b")).click();
		}
		catch (Exception ex) {
			ClickElement.clickByCss(Helper.driver, "#sampleId_cust-cb-lst-txt_20210921-TestAut-PA-11121");
		}
		Test_Elements.wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
		Thread.sleep(1500);
		...
		for (int x=0; x<12; x++) {
			...
			String getAssay = Helper.driver.findElement(By.cssSelector("#row-"+x+" #col-"+Test_Elements.slAssayCol)).getText();
			softAssert.assertTrue(getAssay.equalsIgnoreCase("Salmonella"));
...
//		}
			...
			Thread.sleep(2000);
			Helper.driver.findElement(By.id("dilution-factor-var")).click();
			Helper.driver.findElement(By.id("newSampleMatrix3LId")).sendKeys("Smmatrix1");

			Helper.driver.findElement(By.cssSelector(".m-l-5px#btn-save")).click();
			Test_Elements.wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
			Thread.sleep(1000);
			Helper.driver.findElement(By.cssSelector("#sampleMatrix3LId input")).sendKeys("Smmatrix1");
			Helper.driver.findElement(By.cssSelector("#sampleMatrix3LId input")).sendKeys(Keys.ENTER);
			Thread.sleep(750);
			Helper.driver.findElement(By.cssSelector("#ImprocVersion3LId input")).sendKeys(Test_Variables.slImprocVersion);
			Helper.driver.findElement(By.cssSelector("#ImprocVersion3LId input")).sendKeys(Keys.ENTER);
...
//			WebElement element = Helper.driver.findElement(By.cssSelector("#MicrobialItemsId1LCCV input"));
