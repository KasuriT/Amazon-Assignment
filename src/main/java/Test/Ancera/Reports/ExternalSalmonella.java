...
//						}	
	...
	public void SalmonellaLock() throws InterruptedException, IOException {
		...
		try {
			Test_Variables.test = Test_Variables.extent.createTest("AN-ESL-83: Verify Salmonella Lock Filter Functionality", "This test case will test Salmonella Lock Filter Functionality");
			Test_Variables.preconditions = Test_Variables.test.createNode(Scenario.class, Test_Variables.PreConditions);
			Test_Variables.steps = Test_Variables.test.createNode(Scenario.class, Test_Variables.Steps);
			Test_Variables.results = Test_Variables.test.createNode(Scenario.class, Test_Variables.Results);
	...
	public void PNGExport() throws InterruptedException, IOException {
		...
		try {
			Test_Variables.test = Test_Variables.extent.createTest("AN-ESL-95: Verify user can download External Salmonella PNG file", "This test case will verify user can download External Salmonella PNG file");
	...
	public void CSVExport() throws InterruptedException, IOException {
		...
		try {
			Test_Variables.test = Test_Variables.extent.createTest("AN-ESL-96: Verify user can download Salmonella CSV file", "This test case will verify that user can download Salmonella CSV file");
	...
	public void TemplateExport() throws InterruptedException, IOException {
		...
		try {	
			Test_Variables.test = Test_Variables.extent.createTest("AN-ESL-97: Verify user can download Salmonella Template file", "This test case will verify that user download Salmonella Template file");
