...
public class SalmonellaLog {
	...
	@Test (description="Test Case: Test Salmonella Audit Download",enabled= true, priority = 19) 
	...
	@Test (description="Test Case: Test Salmonella Template Download",enabled= true, priority = 20) 
