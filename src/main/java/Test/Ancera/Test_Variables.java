...
//	public static String RoleName = "Test Role0051";
	...
	public static ArrayList<PiperSoftwareModel> lstPSManagement = new ArrayList<>(
			Arrays.asList(
					new PiperSoftwareModel("AN-PSM-02: Verify user can upload pdf file", "This test case will verify that user can upload pdf file", "User was not able to upload pdf file successfully", "User was able to upload pdf file", "/EULA/sample.pdf", "PNG file", "Invalid file uploaded. Please upload a file with .msi extension", ".custom-tab:nth-child(1)", "userapp"),
					...
					new PiperSoftwareModel("AN-PSM-09: Verify user can upload pdf file", "This test case will verify that user can upload pdf file", "User was not able to upload pdf file successfully", "User was able to upload pdf file", "/EULA/sample.pdf", "PNG file", "Invalid file uploaded. Please upload a file with .zip extension", ".custom-tab:nth-child(2)", "improSalm"),
					...
					new PiperSoftwareModel("AN-PSM-16: Verify user can upload pdf file", "This test case will verify that user can upload pdf file", "User was not able to upload pdf file successfully", "User was able to upload pdf file", "/EULA/sample.pdf", "PNG file", "Invalid file uploaded. Please upload a file with .zip extension", ".custom-tab:nth-child(3)", "improCocc"),
	...
	///////////////////////////////////////////////////////////Salmonella Ingest//////////////////////////////////////////////////////////////////			
	public static String CartridgeID = "TestCartridge"+date0;
	public static String InstrumentID = "PSN0009";
	public static String UserID = "100";
	public static String RunID = "Test"+lstSampleID.get(0);
	public static String PiperUser = "Jalam";
	public static String ImprocVersion = "9.7.1.5";
	...
	public static String slCSVAuditFileName = "Salmonella Log Audit - ";
	...
	public static String PA_SampleMatrixSalm = "AT_SampleMatrix";
	public static String PA_SampleMatrixList = "AT_SampleMatrixListeria";
	public static String PA_SampleMatrixID = "201";
	public static String PA_SampleMatrixIDListeria = "";
	public static String PA_ImprocVersion = "4.0.8.2";
	public static String PA_Threshold = "1000";
	public static String PA_fileName = "PA_Config_Sample_Metadata_Upload.xlsx";
	...
	public static ArrayList<ProfileModel> lstProfileNavigate = new ArrayList<>(
			Arrays.asList(
					...
					new ProfileModel(Constants.url_barcodeManagement, "AN-PS-06: Navigate to Profile Setting from barcode Management Screen", "This test case will verify user can navigate to Profile Setting page from Piper Management Screen", "1. Hover to sidebar and click on Piper Management"),
					new ProfileModel(Constants.url_agreementManagement, "AN-PS-07: Navigate to Profile Setting from Agreement Management Screen", "This test case will verify user can navigate to Profile Setting page from Agreement Management Screen", "1. Hover to sidebar and click on Agreement Management"),
					new ProfileModel(Constants.url_alert, "AN-PS-08: Navigate to Profile Setting from Alert Management Screen", "This test case will verify user can navigate to Profile Setting page from Alert Management Screen", "1. Hover to sidebar and click on Alert Management"),
					new ProfileModel(Constants.url_piperManagement, "AN-PS-09: Navigate to Profile Setting from Piper Management Screen", "This test case will verify user can navigate to Profile Setting page from Piper Management Screen", "1. Hover to sidebar and click on Piper Management"),
					new ProfileModel(Constants.url_piperSoftware, "AN-PS-10: Navigate to Profile Setting from Piper Software Management Screen", "This test case will verify user can navigate to Profile Setting page from Piper Management Screen", "1. Hover to sidebar and click on Piper Management"),
					new ProfileModel(Constants.url_piperConfiguration, "AN-PS-11: Navigate to Profile Setting from Piper Configuration Management Screen", "This test case will verify user can navigate to Profile Setting page from Piper Management Screen", "1. Hover to sidebar and click on Piper Management"),
					new ProfileModel(Constants.url_dataTemplate, "AN-PS-12: Navigate to Profile Setting from Data Template Screen", "This test case will verify user can navigate to Profile Setting page from Data Template Screen", "1. Hover to sidebar and click on Data Template"),
					new ProfileModel(Constants.url_dataUpload, "AN-PS-13: Navigate to Profile Setting from Data Upload Screen", "This test case will verify user can navigate to Profile Setting page from Data Upload Screen", "1. Hover to sidebar and click on Data Upload"),
					new ProfileModel(Constants.url_poultryManagement, "AN-PS-14: Navigate to Profile Setting from Poultry Management Screen", "This test case will verify user can navigate to Profile Setting page from Alert Management Screen", "1. Hover to sidebar and click on Alert Management"),
					new ProfileModel(Constants.url_reports, "AN-PS-15: Navigate to Profile Setting from Reports Screen", "This test case will verify user can navigate to Profile Setting page from Reports Screen", "1. Hover to sidebar and click on Reports"),
					new ProfileModel(Constants.url_SalmonellaLog, "AN-PS-16: Navigate to Profile Setting from Salmoenella Screen", "This test case will verify user can navigate to Profile Setting page from Salmonella Screen", "1. Hover to sidebar; click on Reports and select Salmonella log Report"),
				...
				//	new ProfileModel(Constants.url_ExternalMPNSalmonellaLog, "AN-PS-15: Navigate to Profile Setting from External MPN Salmonella Log Screen", "This test case will verify user can navigate to Profile Setting page from External MPN Salmonella Log Screen", "1. Hover to sidebar; click on Reports and select External MPN Salmonella Log"),
					new ProfileModel(Constants.url_CoccidiaLog, "AN-PS-17: Navigate to Profile Setting from Coccidia Log Screen", "This test case will verify user can navigate to Profile Setting page from Coccidia Log Screen", "1. Hover to sidebar; click on Reports and select Coccidia Log"),
					new ProfileModel(Constants.url_CoccidiaTimeline, "AN-PS-18: Navigate to Profile Setting from Coccidia Timeline Screen", "This test case will verify user can navigate to Profile Setting page from Coccidia Timeline Screen", "1. Hover to sidebar; click on Reports and select Coccidia Timeline"),
