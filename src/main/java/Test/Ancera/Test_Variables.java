	...
	public static ArrayList<ProfileModel> lstProfileNavigate = new ArrayList<>(
			Arrays.asList(
				...
				new ProfileModel(Constants.url_user,"AN-PS-02: Navigate to Profile Setting from User Management Screen", "This test case will verify user can navigate to Profile Setting page from User Management Screen", "1. Hover to sidebar and click on User Management", "User Management"),
					...
					new ProfileModel(Constants.url_SalmonellaLog, "AN-PS-19: Navigate to Profile Setting from Salmoenella Screen", "This test case will verify user can navigate to Profile Setting page from Salmonella Screen", "1. Hover to sidebar; click on Reports and select Salmonella log Report", "Salmonella Log"),
					new ProfileModel(Constants.url_CoccidiaLog, "AN-PS-20: Navigate to Profile Setting from Coccidia Log Screen", "This test case will verify user can navigate to Profile Setting page from Coccidia Log Screen", "1. Hover to sidebar; click on Reports and select Coccidia Log", "Coccidia Log"),
			...
			//		new ProfileModel(Constants.url_LocalDashboard, "AN-PS-19: Navigate to Profile Setting from Local Dashboard Screen", "This test case will verify user can navigate to Profile Setting page from Local Dashboard Screen", "1. Hover to sidebar; click on Reports and select Local Dashboard", "Local Dashboard"),
					new ProfileModel(Constants.url_SitesLog, "AN-PS-21: Navigate to Profile Setting from Sites Log Screen", "This test case will verify user can navigate to Profile Setting page from Sites Log Screen", "1. Hover to sidebar; click on Reports and select Sites Log", "Sites Log")
					));
