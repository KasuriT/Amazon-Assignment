...
public class FieldAccess {
    ...
    @Test(enabled = true)
    public static void FieldAccessFunctionality(By fieldAccessIcon) throws InterruptedException, IOException {
        ...
        try {
            ...
            for (String fieldNameToCheck : fieldNamesToCheck) {
                ...
                List<WebElement> matchingElements = driver.getDriver().findElements(By.xpath(xpathExpression));
                if (matchingElements.isEmpty()) {
                    System.out.println("TC passed: Column '" + fieldNameToCheck + "' is not found on the page.");
                } else {
                    for (WebElement element : matchingElements) {
                        softAssert.assertFalse(element.isDisplayed(), fieldNameToCheck + " column is not hidden, TC failed");
                    }
                }
            }
...
*/
    ...
    @Test(enabled = true)
    public static void KeyColumnsCheck(By fieldAccessIcon, String[] keyColumnsExpected) throws InterruptedException, IOException {
