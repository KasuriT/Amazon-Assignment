...
import static Test.Ancera.DBValidations.Queries.DSCoccidiaFlock_Queries.*;

import static MiscFunctions.ExtentVariables.extent;
import static ExtentReports.ExtentReport.initReport;


public class DSCoccidiaFlockView extends DB_Config_DW {


    @BeforeSuite
    public static void setUp() {
        initReport("DSCoccidiaFlockView");
    }
