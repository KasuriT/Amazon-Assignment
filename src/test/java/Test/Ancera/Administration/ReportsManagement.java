...
public class ReportsManagement extends BaseTest{
	...
	public void CreateRole() throws InterruptedException, IOException {
		try {
			...
			getDriver().findElement(rmName).sendKeys(RoleName);
			getDriver().findElement(rmDesc).sendKeys("Role created by automation script");
			getDriver().findElement(popupSaveButton).click();
				waitElementInvisible(loading_cursor);
			Thread.sleep(1000);
	...
	public void AuditTrail() throws InterruptedException, IOException {
		try{
			...
			waitElementInvisible(loading_cursor);
			Thread.sleep(3000);
            getDriver().findElement(By.cssSelector("th:nth-child(4) li:nth-child(1) label")).click();                      			  
			waitElementInvisible(loading_cursor);
			Thread.sleep(1000);
