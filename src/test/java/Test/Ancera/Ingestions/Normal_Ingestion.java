				...
				for (@SuppressWarnings("unused") ReportFilters objFilter : objModel.lstFilters) {
					...
					for(int i=0; i<lstSalmonellaIngest.size(); i++)	{
						...
						try{
							...
							driver.findElement(By.id("sampleId_search-input")).sendKeys(SampleID_Salm);
							wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
							Thread.sleep(2500);	
							try {
								driver.findElement(By.cssSelector("#sampleId_cust-cb-lst-txt_"+SampleID_Salm)).click();
								wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
								Thread.sleep(2000);	
							}
							catch (Exception ex) {
								ClickElement.clickByCss(driver, "#sampleId_cust-cb-lst-txt_"+SampleID_Salm);
								wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
								Thread.sleep(2000);	
							}
							...
							for(int j = 0; j<12; j++) {
								...
								String getRunType_NormalIngestion = driver.findElement(By.cssSelector("#row-"+j+" #col-"+slRunTypeCol+" label")).getText();
								...
								String getAuditRunType_NormalIngestion = driver.findElement(By.cssSelector("tr:nth-child(1) #col-"+slAuditRunTypeCol+".text-dark")).getText();
						...
						//	FileInputStream fsIP= new FileInputStream(new File("./Excel/"+fileName));
							...
							if (driver.findElement(By.id("results-found-count")).getText().equals("12")) {
								...
								Thread.sleep(1000);
								driver.findElement(By.id("file-input")).sendKeys(FrameworkConstants.NormalIngestionTemplateUpload);
								wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
								...
								driver.findElement(By.id("sampleId_search-input")).clear();
								driver.findElement(By.id("sampleId_search-input")).sendKeys(SampleID_Salm+"Updt");
								wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
								Thread.sleep(2000);
								try {
									ClickElement.clickByCss(driver, "#sampleId_cust-cb-lst-txt_"+SampleID_Salm+"Updt");
									wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
									Thread.sleep(2000);
								}
								catch (Exception ex) {
									driver.findElement(By.cssSelector("#sampleId_cust-cb-lst-txt_"+SampleID_Salm+"Updt")).click();
									wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
									Thread.sleep(2000);
								}
		...
		for (NormalIngestionModel objModel : NormalIngestionModel.lstNormalIngestion) { 
			...
			for (ReportFilters objFilter : objModel.lstFilters) {
				...
				try{
					...
					driver.findElement(By.id("sampleId_search-input")).clear();
					driver.findElement(By.id("sampleId_search-input")).sendKeys(SampleID_Cocci);
					wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
					Thread.sleep(2000);	
					try {
						driver.findElement(By.cssSelector("#sampleId_cust-cb-lst-txt_"+SampleID_Cocci)).click();
					}
					catch(Exception ex) {
						Thread.sleep(1000);
						driver.findElement(By.cssSelector("#sampleId_cust-cb-lst-txt_"+SampleID_Cocci)).click();
					...
					for(int j = 0; j<12; j++) {
						...
						steps.createNode("Verify Run Type as "+RunType_NormalIngestion+" in API body for lane" +lane);
						String getRunType_NormalIngestion = driver.findElement(By.cssSelector("#row-"+j+" #col-"+clRunTypeCol+" label")).getText();
						softAssert.assertEquals(getRunType_NormalIngestion, RunType_NormalIngestion, "Run Type is not displayed in table");
					...
					//	softAssert.assertEquals(getAuditUser, PiperUser);
						...
						steps.createNode("Verify Run Type is displayed in Audit log for lane" +lane);
						String getAuditRunType_NormalIngestion = driver.findElement(By.cssSelector("tr:nth-child(1) #col-"+clAuditRunTypeCol+".text-dark")).getText();
						softAssert.assertEquals(getAuditRunType_NormalIngestion, RunType_NormalIngestion);
				...
				try {	
					...
					if (driver.findElement(By.id("results-found-count")).getText().equals("12")) {
						...
						Thread.sleep(1000);
						driver.findElement(By.id("sampleId_search-input")).clear();
						driver.findElement(By.id("sampleId_search-input")).sendKeys(SampleID_Cocci+"Updt");
						wait.until(ExpectedConditions.invisibilityOfElementLocated(By.id("notification-loading")));
						Thread.sleep(2000);				

						try {
							driver.findElement(By.cssSelector("#sampleId_cust-cb-lst-txt_"+SampleID_Cocci+"Updt")).click();
						}
						catch (Exception ex) {
							ClickElement.clickByCss(driver, "#sampleId_cust-cb-lst-txt_"+SampleID_Cocci+"Updt");
						}
