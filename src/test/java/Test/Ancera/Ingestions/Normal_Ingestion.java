						...
						//	FileInputStream fsIP= new FileInputStream(new File("./Excel/"+fileName));
							...
							if (getDriver().findElement(By.id("results-found-count")).getText().equals("12")) {
								...
								//	int laneNumber = Integer.parseInt(laneGetText);
									...
									String getFlockID = getDriver().findElement(By.cssSelector("#row-"+k+" #col-"+slFlockIDCol+" label")).getText();
				...
				try {	
					...
					if (getDriver().findElement(By.id("results-found-count")).getText().equals("12")) {
						...
						for (int k=0; k<12;k++) {
							...
							String getFlockID = getDriver().findElement(By.cssSelector("#row-"+k+" #col-"+clFlockIDCol+" label")).getText();
							softAssert.assertEquals(getFlockID, FlockID);
