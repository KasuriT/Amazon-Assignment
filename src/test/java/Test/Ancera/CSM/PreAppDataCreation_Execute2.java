        ...
        for (CSMModel objModel : CSMModel.lstComplexConfig) {
            if (objModel.createFlock) {
                try {
                    ...
                    type(flockFarmDropdownSearch, CSMModel.organizationFarm1Name);
                    waitElementInvisible(loading_cursor);
                    ...
                    type(flockIntegratorFlockID, CSMModel.flockIntegratorID);
                    ...
                    Thread.sleep(1000);
                    //		click(By.cssSelector(".placementDate button[data-date= '02/01/2023']"));
                    click(By.cssSelector(".placementDate button[data-date= '" + DateUtil.dateMMDDYYYY1 + "']"));
                    Thread.sleep(1000);

                    try {
                        scroll(flockHousePlacedDropdownExpand);
                ...
                try {
                    ...
                    if (getDriver().findElement(By.id(ResultsCount)).getText().equals("12")) {
                        for (int z = 0; z < 12; z++) {
                            ...
                            String selectQuery = "Select unique_Flock_id from dbo.flock_mgmt where integrator_flock_id = '" + CSMModel.flockIntegratorID + "' and Bird_Size = '" + objModel.birdSizeName + "'";
